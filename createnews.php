...
<label style="text-align:center;align:center;font-size:40px;margin-left:500px" align="center">News</label>
<br>
<br>
<form action="actionnews.php" method="post">
<div class="form-group">
    <label for="img">Heading:</label><i class="glyphicon glyphicon-user"></i>
    <input type="text" class="form-control" name="heading" id="heading" required>
  </div> 
  <div class="form-group">
    <label for="heading">Content:</label><i class="glyphicon glyphicon-user"></i>
